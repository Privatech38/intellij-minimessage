...
public class MiniMessagePossibleTagImpl extends ASTWrapperPsiElement implements MiniMessagePossibleTag {

  public MiniMessagePossibleTagImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MiniMessageVisitor visitor) {
    visitor.visitPossibleTag(this);
  }
  ...
  @Override
  @Nullable
  public MiniMessageEmptyTag getEmptyTag() {
    return findChildByClass(MiniMessageEmptyTag.class);
  }

  @Override
  @Nullable
  public MiniMessageTag getTag() {
    return findChildByClass(MiniMessageTag.class);
  }
